                            ...
                            <form action="{{ route('admin.product.edit.post') }}" method="post"
                                ...
                                <div class="card card-success card-outline mb-4"> <!--begin::Header-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3"> 
                                            <span class="input-group-text" id="code"> mã </span> 
                                                <input type="text" class="form-control"
                                                placeholder="241" name="code" value="{{$data->code}}"> 
                                        </div>
                                        <div class="input-group mb-3"> 
                                            <span class="input-group-text" id="name_product">tên sản phẩm </span> 
                                            <input type="text" class="form-control" placeholder="tên sản phẩm" name="name_product" value="{{$data->name_product}}"> 
                                        </div>
                                    
                                        <div class="input-group mb-3"> 
                                            <span class="input-group-text" id="name_product2">tên dưới </span> 
                                            <input type="text" class="form-control" placeholder="tên dưới" name="name_product2" value="{{$data->name_product2}}"> 
                                        </div>
                                        <div class="input-group mb-3"> 
                                            <span class="input-group-text" id="volume">đóng gói </span> 
                                            <input type="text" class="form-control" placeholder="nhập đầy đủ" name="volume" value="{{$data->volume}}"> 
                                        </div>
                                        <div class="input-group mb-3"> 
                                        ...
                                        <div class="input-group mb-3"> 
                                            ...
                                            <input type="text" class="form-control" placeholder="nếu có" name="discount" value="{{$data->discount}}"> 
                                        </div>
