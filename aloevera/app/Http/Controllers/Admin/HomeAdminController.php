...
class HomeAdminController extends Controller
{
    ...
    public function index(){
        ...
        $data[$i]['discount'] = $this->handleRepo->currency_format($data[$i]['discount']);
        // Chuyển chuỗi thành html
        $data[$i]['description'] = Str::of($data[$i]['description'])->toHtmlString();
        $data[$i]['name_product'] = Str::of($data[$i]['name_product'])->toHtmlString();
    ...
    public function add_post(Request $request){
       ...
       //End xử lý
        $attributes = [
            ...
            'name_product2'=>$request->name_product2,
